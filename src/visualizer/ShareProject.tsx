...
const _shareSubject = 'Take inspiration to the next level. See YOUR room come to life';

const ShareProjectCached = React.memo<ShareProjectProps>(
...
export function ShareProject(props: ShareProjectProps) {
    return <ShareProjectCached {...props} />
}
